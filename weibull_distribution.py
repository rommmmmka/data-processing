...
def weibull(train, test, columns, param, file_limits, weibull_shape, plot_path=None):
    print(param)
...
def main():
    ...
    if o == "1":
        ...
        for param in dict_columns:
            ...
            shapes = np.linspace(weibull_shape_base - 0.7, weibull_shape_base + 0.7, 15)
            errors = []
